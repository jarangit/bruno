...
const Home = ({
  ...
  const buildings = (0,store/* useAppSelector */.CG)(state => state.building);
  const dispatch = (0,store/* useAppDispatch */.TL)(); // const dataBuilding = dispatch(buildingAsync("38"))
...
var __webpack_exports__ = __webpack_require__.X(0, [664,943,394], () => (__webpack_exec__(524)));
