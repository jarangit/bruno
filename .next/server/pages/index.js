...
const Home = ({
  ...
  var _buildings$data$weath, _buildings$data$weath2;
  ...
  const dispatch = (0,external_react_redux_.useDispatch)(); // const dataBuilding = dispatch(buildingAsync("38"))
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
    ...
    }), buildings.data ? /*#__PURE__*/jsx_runtime_.jsx(monitor, {
...
async function getStaticProps() {
  ...
  const listBuilding = await fecthApi(`https://api.airin1.com/api/tenants?building_id=38`); // const dataBuilding = dispatch(buildingAsync("38"))
...
var __webpack_exports__ = __webpack_require__.X(0, [664,788,394,413], () => (__webpack_exec__(524)));
